 ...
 <?php 
   ...
   foreach ($_SESSION["cart_array"] as $each_item) {
    ...
    $per_price=$price;
   	...
   	$cartOutput .= '<td> <form action="cust_cart.php" method="POST"><input name="deletBtn '.$item_id.'" type="submit" value="X" /><input name="index_to_remove" type="hidden" value=' .$i. ' /></form></td>';
    $cartOutput .= "</tr>";
    $i++;
   }
